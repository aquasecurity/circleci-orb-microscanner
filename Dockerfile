...
#   && firefox --version
# likely want this code in the future, but until we're ready to upgrade our version of firefox to 53+, geckodriver wont' be compatible...
# install geckodriver—disabling this temporarily, we will 
